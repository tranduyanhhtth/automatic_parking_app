...
public:
    int id = 0;
    QString rfid;            // Đã mã hóa/che mờ trước khi lưu
    QString plateFront;      // Đã mã hóa/che mờ
    QString plateRear;       // Đã mã hóa/che mờ
    qint64 checkinTime = 0;  // epoch seconds
    qint64 checkoutTime = 0; // 0 nếu chưa checkout
