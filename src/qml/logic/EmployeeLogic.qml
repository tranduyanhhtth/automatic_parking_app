...
Item {
    ...
    // ADDED: Properties to control button enabled state
    ...
    // MODIFIED: Update selection and button states
    ...
    // MODIFIED: Simplified addEmployee
    ...
    // MODIFIED: Simplified updateEmployee
    ...
    // ADDED: Functions to handle button clicks
    ...
    // MODIFIED: Simplified clearForm and added button state reset
    function clearForm() {
